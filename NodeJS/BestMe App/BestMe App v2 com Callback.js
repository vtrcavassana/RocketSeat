...
// Fazendo o callback do evento 'exit' (que é chamado quando o processo é finalizado)
process.on('exit', () => {
    console.log(`Que show!
    
    Recapitulando:
    
    A resposta da pergunta "${perguntas[0]}" foi: ${respostas[0]}
    
    A resposta da pergunta "${perguntas[1]}" foi: ${respostas[1]}
    
    A resposta da pergunta "${perguntas[2]}" foi: ${respostas[2]}
    
    A resposta da pergunta "${perguntas[3]}" foi: ${respostas[3]}
